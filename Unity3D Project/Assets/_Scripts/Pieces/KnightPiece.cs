...
public class KnightPiece : BasePiece
{
    ...
    public override void OnSelected()
    {
        ...
        if (x < 7 && y < 6) cells.Add(ChessBoard.current.Cells[x + 1][y + 2]);
        if (x < 6 && y < 7) cells.Add(ChessBoard.current.Cells[x + 2][y + 1]);

        if (x < 7 && y > 1) cells.Add(ChessBoard.current.Cells[x + 1][y - 2]);
        if (x < 6 && y > 0) cells.Add(ChessBoard.current.Cells[x + 2][y - 1]);

        if (x > 0 && y < 6) cells.Add(ChessBoard.current.Cells[x - 1][y + 2]);
        if (x > 1 && y < 7) cells.Add(ChessBoard.current.Cells[x - 2][y + 1]);

        if (x > 0 && y > 1) cells.Add(ChessBoard.current.Cells[x - 1][y - 2]);
        if (x > 1 && y > 0) cells.Add(ChessBoard.current.Cells[x - 2][y - 1]);
